...
| :fire-related-events-only |          boolean          |            `false`            | Defines if only events related to the selected containers will be fired  | :expanded |          boolean          |            `false`            | Defines if the container expands to the parents full height                                                                                                                                       |
